L.ITUzonesWorked = L.LayerGroup.extend({
    ...
    draw: function () {
        ...
        var polygonFeatures = ITU_ZONES_POLYGONS.features
            .filter(function (f) {
...
L.ituzonesWorked = function (options) {
    return new L.ITUzonesWorked(options);
};
